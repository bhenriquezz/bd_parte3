window.onload = () => {
    if(window.location == 'https://projetobd-ufs.000webhostapp.com/index.php' || window.location == 'https://projetobd-ufs.000webhostapp.com/' || window.location == 'https://projetobd-ufs.000webhostapp.com/index.php#') {
        obterProdutos()
        obterCategorias()
    } else {
...
function criarCard(id, nome, especificacao, status) {
    ...
    btnAlterar.addEventListener('click', () => {
        window.location.href = "https://projetobd-ufs.000webhostapp.com/alterar_produto.php?id=" + cardContainer.id
    })
        ...
        if(confirmacao) {
            ...
            ajax.onreadystatechange = () => {
                if(ajax.readyState == 4 && ajax.status == 200) {
                    window.location = "https://projetobd-ufs.000webhostapp.com/index.php"
...
function listarCategorias(categorias) {
    ...
    categorias.forEach(e => {
        ...
        btnExcluir.addEventListener('click', () => {
            confirmacao = window.confirm("Deseja realmente excluir a categoria " + "'" + categoria.innerText + "'")
